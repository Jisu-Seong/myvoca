const ResultModal = ({ title, content, callbackFn }) => {
  return (
    ...
    >
      <div
        className="absolute bg-white shadow dark:bg-grey-700 opacity-100 
            w-1/4 rounded mt-10 mb-10 px-6 min-w-[600px]"
      >
        <div className="justify-center bg-warning-400 mt-6 mb-6 text-2xl border-b-4 border-grey-500">
          {title}
        </div>
